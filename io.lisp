...
(defun look ()
   (princ (locale-description (player-location (find-player-from-stream user-stream))) user-stream))
(defun north ()
   (if (locale-north (player-location (find-player-from-stream user-stream)))
       (progn (setf (player-location (find-player-from-stream user-stream) (locale-north (player-location (find-player-from-stream user-stream)))))
	(look))
...
(defun east ()
  (if (locale-east (player-location (find-player-from-stream user-stream)))
      (progn (setf player-location (find-player-from-stream user-stream) (locale-east (player-location (find-player-from-stream user-stream))))
	     (look))
...
(defun west ()
  (if (locale-west (player-location (find-player-from-stream user-stream)))
      (progn (setf player-location (find-player-from-stream user-stream) (locale-west (player-location (find-player-from-stream user-stream))))
	     (look))
...
(defun south ()
  (if (locale-south (player-location (find-player-from-stream user-stream)))
      (progn (setf player-location (find-player-from-stream user-stream) (locale-south (player-location (find-player-from-stream user-stream))))
	     (look))
...
(defun up ()
  (if (locale-up (player-location (find-player-from-stream user-stream)))
      (progn (setf player-location (find-player-from-stream user-stream) (locale-up (player-location (find-player-from-stream user-stream))))
	     (look))
...
(defun down ()
  (if (locale-down (player-location (find-player-from-stream user-stream)))
      (progn (setf player-location (find-player-from-stream user-stream) (locale-down (player-location (find-player-from-stream user-stream))))
	     (look))
...
(defun in ()
    (if (locale-in (player-location (find-player-from-stream user-stream)))
      (progn (setf player-location (find-player-from-stream user-stream) (locale-in (player-location (find-player-from-stream user-stream))))
	     (look))
...
(defun out ()
    (if (locale-out (player-location (find-player-from-stream user-stream)))
      (progn (setf player-location (find-player-from-stream user-stream) (locale-out (player-location (find-player-from-stream user-stream))))
	     (look))
